...
/**
 * @class PlayerIce class
 * @description PlayerIce.js key objective is to represent the user-controlled character in the ice level.
 * @extends PlayerBase 
 */
export class PlayerIce extends PlayerBase {

    /** GameObject instantiation: constructor for PlayerIce object
