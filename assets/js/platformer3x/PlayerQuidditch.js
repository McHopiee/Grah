 ...
 * @description PlayerQuidditch handles the user-controlled character in the Quidditch level.
 * @extends PlayerBase 
 */
export class PlayerQuidditch extends PlayerBase {

    /** GameObject instantiation: constructor for PlayerQuidditch object
