 ...
 * @description PlayerSteve.js key objective is to handle the user controlled Steve's actions and animations. 
 * 
 * The PlayerSteve class extends the Character class, which in turn extends the GameObject class.
 * Animations and events are activated by key presses, collisions, and gravity.
 * WASD keys are used by user to control the PlayerSteve object.  
 * 
 * @extends Character
 */
export class PlayerSteve extends Character {
    // Steve-specific initial environment
